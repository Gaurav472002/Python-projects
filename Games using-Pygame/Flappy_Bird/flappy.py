...
def welcomeScreen():
    ...
    playery = int((SCREENHEIGHT - GAME_SPRITES['player'].get_height())/5)
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['numbers'] = ( 
        pygame.image.load('resources/0.png').convert_alpha(),
    ...
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('resources/hit.mp3')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('resources/point.mp3')
   
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('resources/flap.mp3')
